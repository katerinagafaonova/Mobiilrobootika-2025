...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, logging_demo, srv, ConfigLogger)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<logging_demo::srv::ConfigLogger>();
}
