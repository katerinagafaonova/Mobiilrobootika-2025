...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen',
            env=env)
        for i, executable in enumerate('/home/student18/ros2_ws/build/demo_nodes_cpp/list_parameters'.split(';'))
    ]
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/student18/ros2_ws/src/demos/demo_nodes_cpp/test/list_parameters'.split(';')
