...
def generate_test_description():
    ...
    showimage_executable = '/home/student18/ros2_ws/build/image_tools/showimage'
    ...
    cam2image_executable = '/home/student18/ros2_ws/build/image_tools/cam2image'
    ...
    def test_reliable_qos(self, proc_output, showimage_node, cam2image_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/student18/ros2_ws/src/demos/image_tools/test/showimage'
            ), process=showimage_node, output_filter=output_filter, timeout=10
        )
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/student18/ros2_ws/src/demos/image_tools/test/cam2image'
