...
def generate_test_description():
    ...
    processes_under_test = [
        ...
        for i, executable in enumerate('/home/student18/ros2_ws/build/demo_nodes_cpp_native/talker'.split(';'))
    ]
...
class TestExecutablesTutorial(unittest.TestCase):
    ...
    def test_executables_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/student18/ros2_ws/src/demos/demo_nodes_cpp_native/test/talker'.split(';')
