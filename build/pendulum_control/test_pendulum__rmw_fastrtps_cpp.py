...
def generate_test_description():
    ...
    pendulum_logger_process = ExecuteProcess(
        cmd=['/home/student18/ros2_ws/build/pendulum_control/pendulum_logger'],
    ...
    pendulum_demo_process = ExecuteProcess(
        cmd=['/home/student18/ros2_ws/build/pendulum_control/pendulum_demo', '-i', '1000'],
        name='pendulum_demo',
        output='screen'
    )
...
class TestPendulumDemo(unittest.TestCase):
    ...
    def test_pendulum_logger_output(self, proc_output, pendulum_logger_process):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/student18/ros2_ws/src/demos/pendulum_control/test/pendulum_logger'
    ...
    def test_pendulum_demo_output(self, proc_output, pendulum_demo_process):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/student18/ros2_ws/src/demos/pendulum_control/test/pendulum_demo'
