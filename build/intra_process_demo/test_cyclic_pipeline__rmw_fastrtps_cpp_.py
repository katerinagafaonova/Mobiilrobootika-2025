...
def generate_test_description():
    ...
    processes_under_test = [
        ExecuteProcess(
            ...
            output='screen'
        ) for i, executable in enumerate('/home/student18/ros2_ws/build/intra_process_demo/cyclic_pipeline'.split(';'))
    ]
...
class TestExecutablesDemo(unittest.TestCase):
    ...
    def test_executables_output(self, proc_output, processes_under_test):
        ...
        output_files = '/home/student18/ros2_ws/src/demos/intra_process_demo/test/cyclic_pipeline'.split(';')
