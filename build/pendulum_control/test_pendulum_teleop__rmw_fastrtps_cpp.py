...
def generate_test_description():
    ...
    pendulum_demo_process = ExecuteProcess(
        cmd=['/home/student18/ros2_ws/build/pendulum_control/pendulum_demo', '-i', '0'],
        name='pendulum_demo',
        output='screen'
    )
    ...
    pendulum_teleop_process = ExecuteProcess(
        cmd=[sys.executable, execute_with_delay_command, '500',
             '/home/student18/ros2_ws/build/pendulum_control/pendulum_teleop', '100'],
...
class TestPendulumTeleop(unittest.TestCase):
    ...
    def test_pendulum_demo_output(self, proc_output, pendulum_demo_process):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/student18/ros2_ws/src/demos/pendulum_control/test/pendulum_demo_teleop'
    ...
    def test_pendulum_teleop_output(self, proc_output, pendulum_teleop_process):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(
                path='/home/student18/ros2_ws/src/demos/pendulum_control/test/pendulum_teleop'
